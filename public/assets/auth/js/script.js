...
// 20. user-panel profile change js
...
/*=====================
   08. User Dashboard Left Sidebar Show Js
   ==========================*/
$(".left-panel-show").click(function () {
    $(".bg-overlay, .panel-left-sidebar").addClass("show");
});
$(".close-button, .bg-overlay, .user-nav-pills .nav-item .nav-link").click(function () {
    $(".bg-overlay, .panel-left-sidebar").removeClass("show");
});
