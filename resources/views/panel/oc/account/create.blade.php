                    ...
                    <div class="col-sm-8 m-auto">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('ocaccounts.store') }}" method="POST" enctype="multipart/form-data"
                                    ...
                                    <div class="mb-4 row align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="month" class="form-control @error('month') is-invalid @enderror"
                                                   type="number" value="{{old('month')}}" placeholder="1,2,3...">
                                    ...
                                    <div class="mb-4 row align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="day" class="form-control @error('day') is-invalid @enderror"
                                                   type="number" value="{{old('day')}}" placeholder="1,2,3...">
                                    ...
                                    <div class="mb-4 row align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="month_cnt" class="form-control @error('month_cnt') is-invalid @enderror"
                                                   type="number" value="{{old('month_cnt')}}" placeholder="1,2,3...">
                                    ...
                                    <div class="mb-4 row align-items-center">
                                        ...
                                        <div class="col-sm-9 radio-section">
                                                ...
                                                <label>
                                                    <input type="radio" name="auto_revoke" value="1" {{old('auto_revoke') === 1 ? 'checked' : ''}}>
                                                    <i></i>
                                                    <span>بله</span>
                                                </label>

                                                <label>
                                                    <input type="radio" name="auto_revoke" value="0" {{old('auto_revoke') === 1 || !old('auto_revoke') ? 'checked' : ''}}>
                                                    <i></i>
                                                    <span>خیر</span>
                                                </label>
                                    ...
                                    <div class="mb-4 row align-items-center">
                                        ...
                                        <div class="col-sm-9 radio-section">
                                            ...
                                            <label>
                                                <input type="radio" name="is_paid" value="0" {{old('is_paid') === 1 || !old('is_paid') ? 'checked' : ''}}>
                                                <i></i>
                                                <span>خیر</span>
                                            </label>
