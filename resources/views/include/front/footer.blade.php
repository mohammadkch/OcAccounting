<footer class="section-t-space">
    <div class="container-fluid-lg">
                    ...
                    <div class="service-contain">
                        <div class="service-box">
                            <div class="service-image">
                                <img src="{{ asset('assets/front/svg/product.svg') }}" class="blur-up lazyload" alt="">
                            </div>
                        ...
                        <div class="service-box">
                            <div class="service-image">
                                <img src="{{ asset('assets/front/svg/delivery.svg') }}" class="blur-up lazyload" alt="">
                            </div>
                        ...
                        <div class="service-box">
                            <div class="service-image">
                                <img src="{{ asset('assets/front/svg/discount.svg') }}" class="blur-up lazyload" alt="">
                            </div>
                        ...
                        <div class="service-box">
                            <div class="service-image">
                                <img src="{{ asset('assets/front/svg/market.svg') }}" class="blur-up lazyload" alt="">
                            </div>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="footer-logo">
                        <div class="theme-logo">
                            <a href="index.html">
                                <img src="{{ asset('assets/front/images/logo/1.png') }}" class="blur-up lazyload" alt="">
                            </a>
                        </div>
                                ...
                                <ul>
                                    <li class="mb-0">
                                        <a href="https://play.google.com/store/apps" target="_blank">
                                            <img src="{{ asset('assets/front/images/playstore.svg') }}" class="blur-up lazyload"
                                                 alt="">
                                        </a>
                                    </li>
                                    <li class="mb-0">
                                        <a href="https://www.apple.com/in/app-store/" target="_blank">
                                            <img src="{{ asset('assets/front/images/appstore.svg') }}" class="blur-up lazyload"
                                                 alt="">
                                        </a>
                                    </li>
                                </ul>
        ...
        <div class="sub-footer section-small-space">
            ...
            <div class="payment">
                <img src="{{ asset('assets/front/images/payment/1.png') }}" class="blur-up lazyload" alt="">
            </div>
